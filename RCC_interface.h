...
typedef enum
{
    RCC_AHB_PERIPHERALTYPE_SDIO ,
    RCC_AHB_PERIPHERALTYPE_FSMC ,
    RCC_AHB_PERIPHERALTYPE_CRC  ,
    RCC_AHB_PERIPHERALTYPE_FLITF,
...
typedef enum
{
    ...
    RCC_APB1_PERIPHERALTYPE_BKP,
    RCC_APB1_PERIPHERALTYPE_CAN,
    ...
    RCC_APB1_PERIPHERALTYPE_USART2,
    RCC_APB1_PERIPHERALTYPE_SPI3,
    RCC_APB1_PERIPHERALTYPE_SPI2,
    RCC_APB1_PERIPHERALTYPE_WWDG,
